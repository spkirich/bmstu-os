...
020A:0752 xor ax, ax
020A:0754 mov es, ax
; Инкрементировать младшее слово счётчика реального времени
020A:0756 inc word ptr ds:[006Ch]
020A:075A jnz loc_67
; Инкрементировать старшее слово счётчика реального времени
...
; Обнулить счётчик реального времени
...
; Сбросить флаг работы приводов дисковода
...
По исходному коду обработчика прерывания `08h` была составлена
схема его алгоритма.
